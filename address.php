	...
	<div class="container-fluid">
		<div class="container">
			<div  class="row justify-content-center">
				<div class="col-lg-6">
				<button type="button" class="btn btn-lg btn-primary add-new-client" data-toggle="modal" data-target="#exampleModalCenter" >Add Address</button>	
				</div>
				<div class="col-lg-6">
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered add-record" role="document">
    <div class="modal-content">
      ...
      <form method="POST" id="ins_rec" class="address_form_flds">
          <input type="hidden" class="client_id" name="client_id" value="<?php echo $_GET['client_id'];?>*********" />
          ...
          <div class="modal-body">
			  	<div class="form-group">
					...
					<span class="error-msg street_name_error error"></span>
			  	</div>
			  	<div class="form-group">
					<label><b>City</b></label>
					<input type="text" name="city" class="form-control" placeholder="City">
					<span class="error-msg city_error error"></span>
			  	</div>
                <div class="form-group">
					<label><b>Zipcode</b></label>
					<input type="text" name="zipcode" class="form-control" placeholder="Zipcode">
					<span class="error-msg zipcode_error error"></span>
			  	</div>
                <div class="form-group">
					...
					<span class="error-msg country_error"></span>
			  	</div>
...
$(document).ready(function (){
	...
	$('button.add-new-client').on('click', function()
	{
        ...
        $(".address_form_flds .client_id").val(getUrlParameter('client_id'));
	});
	...
	$('#ins_rec').on("submit", function(e){
		...
		$.ajax({
			...
			type:'POST',
			url:'insprocess.php?page=address',
			data:$(this).serialize(),
